...
/opt/miniconda3/bin/python manage.py runserver 0.0.0.0:8000 > runserver.log 2>&1 &

/opt/miniconda3/bin/jupyter-notebook --notebook-dir=/opt/notebooks --ip='*' --port=8888 --no-browser --allow-root
